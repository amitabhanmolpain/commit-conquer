...
async function fetchProduct(handle: string) {
  ...
  return {
    ...
    description:
      "Premium quality streetwear built for people who move with purpose. No logos, no excess — just craft. Garment-dyed for a lived-in feel, pre-washed for immediate comfort.",
    ...
    images: [
      {
        url: `https://picsum.photos/seed/${handle}1/600/750`,
        alt: "Front",
      },
      {
        url: `https://picsum.photos/seed/${handle}2/600/750`,
        alt: "Back",
      },
      {
        url: `https://picsum.photos/seed/${handle}3/600/750`,
        alt: "Detail",
      },
    ],
...
export default function ProductDetail() {
  ...
  const { addToCart: addCartItem, toggleCart } =
    useCartActions();
  ...
  const addToCart = () => {
    ...
    addCartItem({
      ...
      // backend stores prices in cents
                  ...
                  >
                    <img
                      ...
                      onError={(
                        ...
                        e.target.src =
                          "https://placehold.co/80x96?text=img";
                      }}
                    />
                  </button>
                )
