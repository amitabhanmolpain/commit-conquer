  ...
  return (
    <header style={headerStyle}>
      ...
      <nav style={s.nav}>
        ...
        <NavLink to="/collections" style={navStyle}>
          Collections
        </NavLink>
      ...
      <button
        ...
        onMouseEnter={(e) => {
          ...
          e.target.style.boxShadow =
            theme === "light"
              ? "0 4px 16px rgba(124,106,255,0.2)"
  ...
  return (
    <footer style={theme === "dark" ? s.footer : s.footerLight}>
      <div style={s.footerInner}>
        <span style={theme === "dark" ? { color: "#555", fontSize: 13 } : { color: "#999", fontSize: 13 }}>
          © {new Date().getFullYear()} Commit &amp; Conquer
        </span>
        <div style={{ display: "flex", gap: 20 }}>
          <Link to="/about" style={theme === "dark" ? s.footerLink : s.footerLinkLight}>
            About
          </Link>
          <Link to="/collections" style={theme === "dark" ? s.footerLink : s.footerLinkLight}>
            Collections
          </Link>
          <Link to="/account" style={theme === "dark" ? s.footerLink : s.footerLinkLight}>
            Account
          </Link>
        </div>
      </div>
